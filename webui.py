...
def open1Bb(batch_size,total_epoch,exp_name,if_dpo,if_save_latest,if_save_every_weights,save_every_epoch,gpu_numbers,pretrained_s1, padding_on_left):
    ...
    if(p_train_GPT==None):
        ...
        data["train"]["padding_on_left"]=padding_on_left if not if_dpo else False # False代表padding on right, True代表padding on left
        ...
        with gr.TabItem(i18n("1-GPT-SoVITS-TTS")):
            ...
            with gr.TabItem(i18n("1B-微调训练")):
                ...
                with gr.Row():
                    ...
                    padding_on_left = gr.Checkbox(label=i18n("是否padding在左侧(默认右侧)"), value=False, interactive=True, show_label=True)
                with gr.Row():
